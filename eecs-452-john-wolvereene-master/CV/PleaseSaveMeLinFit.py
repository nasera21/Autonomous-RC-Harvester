...
#move the polyfit so it's in front of the values
diffsMax = np.max(ymod-y_pred)
y_pred_Shift = y_pred+diffsMax
...
print(mid-horizDistShift) #THIS IS THE DISTANCE FROM WALL
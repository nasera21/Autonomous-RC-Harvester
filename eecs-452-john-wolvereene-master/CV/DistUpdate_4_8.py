...
h_val = 164  # H-value of ball for difference image
thold_val =  41 # Threshold value for difference image
v_val = 70 # V-value of ball for difference image
r_val = 59 # R-val of stake for diff image
b_val = 50 #B-val max of stake for diff image
